...
func InitOptionMap() {
	...
	common.OptionMap["Retry429DelaySeconds"] = strconv.Itoa(common.Retry429DelaySeconds)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "Retry429DelaySeconds":
		common.Retry429DelaySeconds, _ = strconv.Atoi(value)
